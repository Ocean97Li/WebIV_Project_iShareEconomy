...
export class UserService {
  ...
  constructor() {
    this._users = [
      new User('Hu Ocean', 'Li', 'Nonnemeerstraat 19-24', {lat: 51.043526, lng: 3.713618}),
      new User('Angela', 'Merkel', 'ReichsStrasse 19-24', {lat: 51.03526, lng: 3.73618}),
      new User('Francois', 'Hollande', 'oooH de Champ de lise 19-24',  {lat: 51.04326, lng: 3.71618}),
      new User('Ragnar', 'LothBrok', 'Plunderstreet 4', {lat: 59.334591, lng: 18.063240}),
      new User('Gimli', 'Son of Gloin', 'MiddleEarthstreet 4', {lat: -36.848461, lng: 174.763336}),
      new User('Mark', 'Rutte', '4 Wetstraat',  {lat: 52.314224, lng: 4.941841}),
      new User('Barack', 'Obama', 'CIA bunker BD911',  {lat: 39.063 , lng: -77.889}),
      new User('Donald', 'Trump', 'CIA bunker BD911', {lat: 39.064, lng: -77.8}),
    ];
    this._objects = [
